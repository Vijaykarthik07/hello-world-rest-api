...
public class HelloWorldController {
	...
	public String helloWorld() {
		return "Hello World From Contineous Deployment Success BPM Links LLC";
	}
	...
	public HelloWorldBean helloWorldBean() {
		...
		// ***-***");
		return new HelloWorldBean("Hello World Vijaykarthik Through Contineous Deployment... BPM Links LLC... ");
	}
