...
public class HelloWorldController {
	...
	public String helloWorld() {
		return "Hello World From Contineous Deployment Success Kalyyan From Nagapattinam..";
	}
	...
	public HelloWorldBean helloWorldBean() {
		...
		// ***-***");
		return new HelloWorldBean("Hello World Vijaykarthik Through Contineous Deployment...Kalyyan... ");
	}
